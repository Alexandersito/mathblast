...
if(isset($_SESSION["idBackend"])){
    ...
    $aula = ModeloAulas::mdlMostrarAulaProfesor($_SESSION["idBackend"]);
...
<head>
    ...
    <title>Math Blast | Backend</title>

    <link rel="icon" href="vistas/img/plantilla/logo.png">

    <script src="
	https://cdn.jsdelivr.net/npm/admin-lte@4.0.0-beta1/dist/js/adminlte.min.js
	"></script>
    <link href="
	https://cdn.jsdelivr.net/npm/admin-lte@4.0.0-beta1/dist/css/adminlte.min.css
	" rel="stylesheet">
...
<body class="sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    ...
    <input type="hidden" id="idBackend" value="<?php echo $_SESSION['idBackend']; ?>">
